...
RUN mkdir -p /comfyui/models/checkpoints && \
    python3 -c "import urllib.request; urllib.request.urlretrieve('https://civitai.com/api/download/models/2368123?token=59b276f4628a091235f594aee42bda27', '/comfyui/models/checkpoints/gonzalomoXLFluxPony_v60PhotoXLDMD.safetensors'); print('Done')"
